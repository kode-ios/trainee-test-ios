...
7. По завершении работ добавь в [readme.md](http://readme.md) реальное время выполнение задач и напиши в телеграм о готовности @eka_jo, чтобы задание начали проверять.
